                ...
                <div className="flex w-full h-full">
                    ...
                    <div className="max-w-[510px] w-full bg-white border-r border-l border-gray-200">
                        <div className="main-bar">
                            <div className="top-bar p-4 flex justify-between text-black items-center">
                                <h2 className="font-bold text-[20px]">ChatNeko</h2>
                                <div>
                                    <span className="inline-block mr-4 p-[5px] hover:bg-gray-200 rounded-[50%]">
                                        <Link href={"/addpage"}>
                                            <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" classna="" fill="none">
                                                ...
                                                <path fillRule="evenodd" d="M0.944298 5.52617L2.99998 8.84848V17.3333C2.99998 18.8061 4.19389 20 5.66665 20H19.3333C20.8061 20 22 18.8061 22 17.3333V6.66667C22 5.19391 20.8061 4 19.3333 4H1.79468C1.01126 4 0.532088 4.85997 0.944298 5.52617ZM4.99998 8.27977V17.3333C4.99998 17.7015 5.29845 18 5.66665 18H19.3333C19.7015 18 20 17.7015 20 17.3333V6.66667C20 6.29848 19.7015 6 19.3333 6H3.58937L4.99998 8.27977Z" fill="currentColor"></path>
                                            </svg>
                                        </Link>
                                    </span>
                                    <span className="inline-block p-[5px] cursor-pointer hover:bg-gray-200 rounded-[50%] ">
                                        <Link href={"/"}>
                                        <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" classna="" fill="none">
                            ...
                            <div className="px-4">
                                <input type="text" placeholder="Search" className="w-full min-h-[40px] pl-3 text-black rounded-4xl bg-gray-50 hover:border hover:border-gray-300" />
                            </div>
                            <div className="px-4">
                                <ul className="flex">
                            ...
                            <div>
                                {peopleData.map((item, index) => (
                                    <ul key={index} className="flex flex-col justify-between items-center px-2">
                                        <li className="flex justify-between cursor-pointer text-black w-full h-[70px] mt-6 py-3 px-3 rounded-lg hover:bg-neutral-100">
                                            <div className="content-wrap flex items-center">
                                                <div className="img-wrap w-[49px] h-[49px] rounded-[50%] mr-3">
                                                    {item.imgSrc && (
                                                        <Image src={item.imgSrc} className="w-full h-full rounded-[50%] object-cover" alt={item.imgAlt} width={49} height={49}>
                                                        </Image>
                                                    )}
                                                </div>
                                                <div className="text-wrap">
                                                    ...
                                                    {item.massage && (
                                                        <p className="Massage text-sm">{item.massage}</p>
                                                    )}
                                                </div>
                                            </div>
                                            {item.time && (
